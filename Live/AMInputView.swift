...
//  TeacherStream
//
//  Created by dimi anat on 2020/7/3.
...
@IBDesignable class AMInputView: UIView,UITextFieldDelegate {
    ...
    private func setup(){
        ...
        textFieldView.spellCheckingType = .no
...
//        backViewHeightExpandConstraint.priority = UILayoutPriority(rawValue: RawValue(expand ? 500:200))
//        labelViewHTopExpandConstraint.priority = UILayoutPriority(rawValue: RawValue(expand ? 500:200))
//        labelViewRightExpandConstraint.priority = UILayoutPriority(rawValue: RawValue(expand ? 500:300))
//        labelViewLeftExpandConstraint.priority = UILayoutPriority(rawValue: RawValue(expand ? 999:300))
        
        backViewHeightExpandConstraint.priority = UILayoutPriority(rawValue: expand ? 500:200)
        labelViewHTopExpandConstraint.priority = UILayoutPriority(rawValue: expand ? 500:200)
        labelViewRightExpandConstraint.priority = UILayoutPriority(rawValue: expand ? 500:300)
