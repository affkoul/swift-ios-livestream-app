...
struct R: Rswift.Validatable {
  ...
  fileprivate static let hostingBundle = Bundle(identifier: "com.geniusandcourage.liveD") ?? Bundle.main
  ...
  struct image {
    ...
    /// Image `frown`.
    static let frown = Rswift.ImageResource(bundle: R.hostingBundle, name: "frown")
    /// Image `gift-1`.
    ...
    /// `UIImage(named: "frown", bundle: ..., traitCollection: ...)`
    static func frown(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.frown, compatibleWith: traitCollection)
    }
  ...
  struct nib {
    /// Nib `AMInputView`.
    static let aMInputView = _R.nib._AMInputView()
    /// Nib `GiftDisplayView`.
    static let giftDisplayView = _R.nib._GiftDisplayView()
    
    /// `UINib(name: "AMInputView", in: bundle)`
    static func aMInputView(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.aMInputView)
    }
...
struct _R: Rswift.Validatable {
  ...
  struct nib: Rswift.Validatable {
    ...
    struct _AMInputView: Rswift.NibResourceType {
      let bundle = R.hostingBundle
      let name = "AMInputView"
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct launchScreen: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "Live") == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'Live' is used in storyboard 'LaunchScreen', but couldn't be loaded.") }
      }
    ...
    struct main: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      let logReg = StoryboardViewControllerResource<LogRegViewController>(identifier: "logReg")
      let logRegBackup = StoryboardViewControllerResource<LogRegViewController>(identifier: "logRegBackup")
      let name = "Main"
      let nvc = StoryboardViewControllerResource<NavigationController>(identifier: "nvc")
      let overlay = StoryboardViewControllerResource<LiveOverlayViewController>(identifier: "overlay")
      ...
      func logReg(_: Void = ()) -> LogRegViewController? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: logReg)
      }
      
      func logRegBackup(_: Void = ()) -> LogRegViewController? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: logRegBackup)
      }
      
      func nvc(_: Void = ()) -> NavigationController? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: nvc)
      }
      
      func overlay(_: Void = ()) -> LiveOverlayViewController? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: overlay)
      }
      ...
      static func validate() throws {
        ...
        if UIKit.UIImage(named: "linkedin") == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'linkedin' is used in storyboard 'Main', but couldn't be loaded.") }
        ...
        if UIKit.UIImage(named: "backImage") == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'backImage' is used in storyboard 'Main', but couldn't be loaded.") }
        ...
        if _R.storyboard.main().logReg() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'logReg' could not be loaded from storyboard 'Main' as 'LogRegViewController'.") }
        if _R.storyboard.main().nvc() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'nvc' could not be loaded from storyboard 'Main' as 'NavigationController'.") }
        if _R.storyboard.main().logRegBackup() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'logRegBackup' could not be loaded from storyboard 'Main' as 'LogRegViewController'.") }
        ...
        if _R.storyboard.main().overlay() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'overlay' could not be loaded from storyboard 'Main' as 'LiveOverlayViewController'.") }
